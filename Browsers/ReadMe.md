...
<RuleCollection Type="Exe" EnforcementMode="Enabled">
  ...
  <FilePublisherRule Id="70fd870b-db2b-4ce5-b96c-828997fcbd65" Name="360ÃÂ¥ÃÂ®Ãâ°ÃÂ¥Ãâ¦ÃÂ¨ÃÂ¦ÃÂµÃÂÃÂ¨ÃÂ§ÃËÃÂ¥Ãâ¢ÃÂ¨, from O=BEIJING QIHU TECHNOLOGY CO., LTD., L=BEIJING, S=BEIJING, C=CN" Description="" UserOrGroupSid="S-1-1-0" Action="Deny">
    <Conditions>
      <FilePublisherCondition PublisherName="O=BEIJING QIHU TECHNOLOGY CO., LTD., L=BEIJING, S=BEIJING, C=CN" ProductName="360ÃÂ¥ÃÂ®Ãâ°ÃÂ¥Ãâ¦ÃÂ¨ÃÂ¦ÃÂµÃÂÃÂ¨ÃÂ§ÃËÃÂ¥Ãâ¢ÃÂ¨" BinaryName="*">
        <BinaryVersionRange LowSection="*" HighSection="*" />
      </FilePublisherCondition>
    </Conditions>
  </FilePublisherRule>
  ...
  <FilePublisherRule Id="bf979a51-5b5f-42ac-a8ad-0f00685b0ad2" Name="&quot;&quot;, in TOR BROWSER, from O=THE TOR PROJECT, INC., L=WINCHESTER, S=NEW HAMPSHIRE, C=US" Description="" UserOrGroupSid="S-1-1-0" Action="Deny">
    <Conditions>
  ...
  <FilePublisherRule Id="e59e3550-2a9c-4e73-9bce-6aec2b564b1b" Name="360ÃÂ¥ÃÂ®Ãâ°ÃÂ¥Ãâ¦ÃÂ¨ÃÂ¦ÃÂµÃÂÃÂ¨ÃÂ§ÃËÃÂ¥Ãâ¢ÃÂ¨, from O=BEIJING QIHU TECHNOLOGY CO., LTD., S=BEIJING, C=CN" Description="" UserOrGroupSid="S-1-1-0" Action="Deny">
    <Conditions>
      <FilePublisherCondition PublisherName="O=BEIJING QIHU TECHNOLOGY CO., LTD., S=BEIJING, C=CN" ProductName="360ÃÂ¥ÃÂ®Ãâ°ÃÂ¥Ãâ¦ÃÂ¨ÃÂ¦ÃÂµÃÂÃÂ¨ÃÂ§ÃËÃÂ¥Ãâ¢ÃÂ¨" BinaryName="*">
        <BinaryVersionRange LowSection="*" HighSection="*" />
      </FilePublisherCondition>
    </Conditions>
  </FilePublisherRule>
  ...
  <FilePathRule Id="fd686d83-a829-4351-8ff4-27c7de5755d2" Name="(Default Rule) All files" Description="Allows members of the Everyone group to run all applications." UserOrGroupSid="S-1-1-0" Action="Allow">
    <Conditions>
  ...
  <FilePublisherRule Id="82d3936b-eb6a-4a4a-b4e3-61385e571948" Name="WAVEBROWSER signed by O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" Description="" UserOrGroupSid="S-1-1-0" Action="Deny">
    <Conditions>
      <FilePublisherCondition PublisherName="O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" ProductName="WAVEBROWSER" BinaryName="*">
        <BinaryVersionRange LowSection="*" HighSection="*" />
      </FilePublisherCondition>
    </Conditions>
  </FilePublisherRule>
  <FilePublisherRule Id="a74bea67-57b1-453b-b5f4-7bd05f75e2be" Name="WAVEBROWSER INSTALLER signed by O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" Description="" UserOrGroupSid="S-1-1-0" Action="Deny">
    <Conditions>
      <FilePublisherCondition PublisherName="O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" ProductName="WAVEBROWSER INSTALLER" BinaryName="*">
	<BinaryVersionRange LowSection="*" HighSection="*" />
      </FilePublisherCondition>
    </Conditions>
  </FilePublisherRule>
  <FilePublisherRule Id="e105447d-3d93-4117-bf7d-19b86d3b6e32" Name="WAVESOR SWUPDATER signed by O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" Description="" UserOrGroupSid="S-1-1-0" Action="Deny">
    <Conditions>
      <FilePublisherCondition PublisherName="O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" ProductName="WAVESOR SWUPDATER" BinaryName="*">
        <BinaryVersionRange LowSection="*" HighSection="*" />
      </FilePublisherCondition>
    </Conditions>
  </FilePublisherRule>
  <FilePublisherRule Id="9ceb567d-a351-469a-b7d2-e06d03653093" Name="WAVE BROWSER signed by O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" Description="" UserOrGroupSid="S-1-1-0" Action="Deny">
    <Conditions>
      <FilePublisherCondition PublisherName="O=WAVESOR SOFTWARE (EIGHTPOINT TECHNOLOGIES LTD. SEZC), L=GEORGE TOWN, C=KY" ProductName="WAVE BROWSER" BinaryName="*">
        <BinaryVersionRange LowSection="*" HighSection="*" />
      </FilePublisherCondition>
    </Conditions>
  </FilePublisherRule>
