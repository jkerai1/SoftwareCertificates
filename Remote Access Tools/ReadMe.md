...
Block list URLs : https://github.com/jkerai1/SoftwareCertificates/blob/main/Bulk-IOC-CSVs/RMM.csv *WARNING* Run as KQL below before attempting to block as you may use some of these!!
